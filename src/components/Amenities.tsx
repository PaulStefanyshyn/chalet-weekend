...
export const Amenities = () => {
  ...
  const [aboutPhotoUrl, setAboutPhotoUrl] = useState('http://localhost:5173/images/1.jpg');
      ...
      <div className="max-w-[1160px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-x-16 lg:gap-y-0 h-full">
          ...
          <div className="block lg:hidden">
            ...
            <div className="text-[15px] space-y-4 opacity-80 font-normal leading-relaxed">
          ...
          <div className="w-full h-full">
            <img 
              src={aboutPhotoUrl} 
              alt="Інтер'єр шале" 
              className="w-full aspect-[4/3] lg:aspect-auto lg:h-full object-cover bg-chalet-input rounded-[32px] shadow-sm" 
            />
          </div>
          ...
          <div className="flex flex-col justify-between w-full h-full lg:py-0">
            ...
            <div className="hidden lg:block">
              ...
              <div className="text-[15px] space-y-4 opacity-80 font-normal leading-relaxed max-w-lg text-chalet-text-dark">
                <p>Ми створили простір, де можна відчути спокій природи, комфорт сучасного будинку та тепло справжнього відпочинку.</p>
                <p>Тут є все для ідеального вікенду — гори, чан, сауна, затишок і тиша.</p>
              </div>
            </div>
          ...
          <div 
             className="w-[60px] h-4 bg-[#E6E6E6] border border-chalet-dark rounded-full mx-auto mt-2 lg:hidden flex items-center px-1 cursor-pointer"
             onClick={() => {
               if (scrollRef.current) {
